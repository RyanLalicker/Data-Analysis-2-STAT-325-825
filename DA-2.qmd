...
$$
In this model all terms match what was included in the first model since all nested effects were removed.  As we move forward with analyzing SAS output from this model, it is important to keep in mind the formula above is modeling $\eta_{ijklmn}$, not ${E}(y_{ijklmn})$.
...
##Best Model to fit Based on the above discussion,
