...
The data set, `data.csv`, and all other files used in this project can be found on our [Github page](https://www.youtube.com/watch?v=dQw4w9WgXcQ): [https://github.com/RyanLalicker/Data-Analysis-2-STAT-325-825](https://github.com/RyanLalicker/Data-Analysis-2-STAT-325-825).
